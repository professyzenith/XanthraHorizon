...
const STEPS = [
  ...
  },
  {
    ...
    metric: "<2s",
    metricLabel: "to craft your edition",
  },
  {
    num: "05",
    title: "Deliver",
    subtitle: "Your timezone. Your chosen time.",
    desc: "At the exact time you chose — whether you're in Mumbai, Milan, or Miami — your Daily Intelligence Brief arrives. A beautifully formatted email. No ads, no sponsored content, no trackers. Just intelligence, on your schedule.",
    color: "#c9a853",
    glow: "rgba(201,168,83,0.35)",
    metric: "10:00 AM",

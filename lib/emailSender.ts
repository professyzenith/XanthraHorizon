  ...
  const storyCards = briefing.stories
    ...
    <div style="margin-bottom:32px;padding:24px;background:#0e0c0a;border:1px solid #1e1b17;border-radius:12px;">
      <div style="display:flex;align-items:center;gap:8px;margin-bottom:12px;">
        ...
        <span style="color:#6b5f4a;font-size:12px;">${story.source}</span>
      </div>
      <h2 style="margin:0 0 12px;font-size:18px;font-weight:600;color:#f0ece3;line-height:1.4;">
        <a href="${story.url}" style="color:#f0ece3;text-decoration:none;">${story.title}</a>
      </h2>
      <p style="margin:0 0 16px;color:#8a8070;font-size:14px;line-height:1.7;">${story.summary}</p>
      <div style="padding:12px 16px;background:#0a0805;border-left:3px solid #c9a853;border-radius:0 6px 6px 0;margin-bottom:16px;">
        ...
        <p style="margin:0;color:#8a8070;font-size:13px;line-height:1.6;">${story.why_it_matters}</p>
      </div>
      <a href="${story.url}" style="display:inline-flex;align-items:center;gap:6px;color:#c9a853;font-size:13px;text-decoration:none;font-weight:500;">
        Read full story →
      </a>
    </div>
  `
...
<head>
  ...
  <title>Xanthra Horizon — ${briefing.date}</title>
</head>
<body style="margin:0;padding:0;background:#060504;font-family:Inter,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">
  <div style="max-width:640px;margin:0 auto;padding:40px 20px;">
    ...
    <div style="text-align:center;margin-bottom:40px;padding-bottom:32px;border-bottom:1px solid #1e1b17;">
      ...
      <h1 style="margin:0 0 4px;font-size:28px;font-weight:700;color:#f0ece3;">${briefing.date}</h1>
      <p style="margin:0 0 4px;color:#c9a853;font-size:13px;font-weight:600;letter-spacing:0.05em;">Know What Matters Next.</p>
      <p style="margin:0;color:#6b5f4a;font-size:14px;">${briefing.stories.length} developments that matter today</p>
    </div>
    ...
    <div style="margin-bottom:40px;padding:24px;background:linear-gradient(135deg,#0d0b09,#110f0c);border:1px solid #2a2318;border-radius:12px;">
      ...
      <p style="margin:0;color:#c4b89a;font-size:16px;line-height:1.7;font-style:italic;">${briefing.executive_brief}</p>
    </div>
    ...
    <div style="text-align:center;padding-top:32px;border-top:1px solid #1e1b17;">
      ...
      <a href="${unsubscribeUrl}" style="color:#52473a;font-size:12px;text-decoration:underline;">Unsubscribe</a>
    </div>
